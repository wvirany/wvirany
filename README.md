...
| :---------: | :---------: |
|   A neural network class that I implemented from scratch (i.e., no external libraries) for a presentation to the Applied Mathematics department at CU Boulder.    |   Predicting diseases in humans from the species present in their gut microbiome as a reimplementation of [Pasolli et al. (2016)](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1004977)|
